  ...
  module TriggerSimulators
    class MetricRateSpike < Base
      ...
      def build_stats(row)
        ...
        baseline_pos_rate = smoothed_rate(baseline_positive, baseline_total, negative: false)

        current_rate, delta_rate =
          case direction.to_s
          when "positive"
            [window_pos_rate, window_pos_rate - baseline_pos_rate]
          when "negative"
            [window_neg_rate, window_neg_rate - baseline_neg_rate]
          else
            max_rate = [window_neg_rate, window_pos_rate].max
            max_delta = [window_neg_rate - baseline_neg_rate, window_pos_rate - baseline_pos_rate].max
            [max_rate, max_delta]
          end
        ...
        compare_rate = direction == "positive" ? baseline_pos_rate : baseline_neg_rate
        ...
        stats = {
          ...
          window_positive_rate: window_pos_rate,
          window_negative_rate: window_neg_rate,
          baseline_positive_rate: baseline_pos_rate,
          baseline_negative_rate: baseline_neg_rate,
          delta_positive_rate: window_pos_rate - baseline_pos_rate,
          delta_negative_rate: window_neg_rate - baseline_neg_rate,
